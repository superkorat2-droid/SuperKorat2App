...
/** ตัวเลือกกลุ่มสาระ/ระดับชั้น — ใช้ทั้งฟอร์มหลังบ้านและตัวกรองหน้าสาธารณะ ต้องเป็นชุดเดียวกัน */
export const SUBJECT_GROUPS = ['ภาษาไทย','คณิตศาสตร์','วิทยาศาสตร์และเทคโนโลยี','สังคมศึกษาฯ','สุขศึกษาและพลศึกษา','ศิลปะ','การงานอาชีพ','ภาษาต่างประเทศ','ปฐมวัย','อื่นๆ']
export const GRADES = ['ป.1','ป.2','ป.3','ป.4','ป.5','ป.6','ม.1','ม.2','ม.3','ม.4','ม.5','ม.6']
