        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <div class="sm:col-span-2">
            ...
            <div v-if="meta.cover_image_url" class="relative rounded-xl overflow-hidden mb-2 bg-slate-100 max-w-sm">
              ...
              <button @click="clearCoverImage" type="button"
                class="absolute top-2 right-2 w-7 h-7 bg-white/90 hover:bg-white/80 backdrop-blur rounded-full flex items-center justify-center shadow">
          ...
          <div>
            ...
            <select v-model="meta.status"
              class="w-full px-4 py-2.5 border border-white/80 bg-white/70 backdrop-blur rounded-xl text-sm focus:outline-none focus:border-primary">
            ...
            <div v-else
              ...
              <div class="flex items-start gap-3">
                ...
                <div class="flex-1 min-w-0 space-y-2">
                  ...
                  <div v-if="q.image_url" class="relative rounded-lg overflow-hidden bg-slate-100 max-w-[200px]">
                    ...
                    <button @click="clearQuestionImage(q)" type="button"
                      class="absolute top-1 right-1 w-6 h-6 bg-white/90 hover:bg-white/80 backdrop-blur rounded-full flex items-center justify-center shadow">
                ...
                <div class="flex items-center gap-2 flex-shrink-0">
                  <select v-model="q.type" @change="onTypeChange(q)"
                    class="px-2 py-1.5 border border-slate-200 rounded-xl text-xs bg-white/70 backdrop-blur focus:outline-none focus:border-primary">
              ...
              <div v-if="q.type === 'rating'" class="ml-16 flex items-center gap-3">
                ...
                <select v-model.number="q.settings.max"
                  class="px-3 py-1.5 border border-slate-200 rounded-xl text-xs bg-white/70 backdrop-blur focus:outline-none focus:border-primary">
